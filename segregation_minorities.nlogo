...
to find-new-spot
  ...
  if color = 105 [ set happy? similar-nearby >= (%-similar-wanted-blue * total-nearby / 100) ]
  if color = 27 [ set happy? similar-nearby >= (%-similar-wanted-orange * total-nearby / 100) ]
  ;%-similar-wanted-orange
...
to update-turtles
  ask turtles [
    ...
    set similar-nearby count (turtles in-radius radius-neigh)  with [ color = [ color ] of myself ]
    set similar-nearby (similar-nearby - 1) ; otherwise it couts itself too
    set other-nearby count (turtles in-radius radius-neigh)  with [ color != [ color ] of myself ]
